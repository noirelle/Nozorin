...
export default function Footer() {
    return (
        <footer className="relative bg-white pt-24 pb-12 overflow-hidden">
            ...
            <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-pink-50 rounded-full blur-3xl opacity-50"></div>
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16 text-center md:text-left">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        <Link href="/" className="inline-flex items-center gap-2 mb-6 group select-none">
                            <LogoIcon className="w-8 h-8 text-[#FF8ba7] transition-transform group-hover:scale-105" />
                            <span className="text-4xl font-display font-bold tracking-tight text-[#FF8ba7] pb-1">
                                nozorin
                            </span>
                        </Link>
                        <p className="text-gray-500 font-medium leading-relaxed mb-6">
                            The world&apos;s friendliest random chat platform. Connect instantly, safely, and for free.
                        </p>
                        <div className="flex gap-4 justify-center md:justify-start">
                            <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-pink-100 hover:text-pink-500 transition-colors">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg>
                            </a>
                            <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-purple-100 hover:text-purple-500 transition-colors">
                    ...
                    <div className="col-span-1">
                        ...
                        <ul className="space-y-4 text-gray-500 font-medium">
                            ...
                            <li><Link href="/guidelines" className="hover:text-pink-500 transition-colors">Community Guidelines</Link></li>
                            <li><Link href="/safety" className="hover:text-pink-500 transition-colors">Safety Center</Link></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-gray-400 text-sm font-medium">
                        © {new Date().getFullYear()} Nozorin Inc. All rights reserved.
                    </p>
