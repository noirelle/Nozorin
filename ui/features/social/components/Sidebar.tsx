...
const navItems = [
    ...
    { icon: Phone, label: 'Calls', isActive: true },
    { icon: Search, label: 'Search', isActive: false },
    { icon: Compass, label: 'Explore', isActive: false },
    { icon: MessageCircle, label: 'Messages', badge: 1, isActive: false },
    { icon: Heart, label: 'Notifications', isActive: false },
    { icon: PlusSquare, label: 'Create', isActive: false },
    { icon: User, label: 'Profile', isActive: true },
];
