...
export default function SignupWizard() {
    ...
    const isStepValid = () => {
        ...
        if (step === 2) return formData.name.length >= 2;
        if (step === 3) return parseInt(formData.age) >= 13;
        if (step === 4) return formData.email.includes('@');
        if (step === 5) return formData.password.length >= 6;
        return false;
    };
            ...
            <div className="w-full max-w-xl flex flex-col h-full">
                ...
                <div className="flex-1 flex flex-col justify-center overflow-y-auto md:overflow-hidden px-2">
                    ...
                    <form onSubmit={handleNext} className="flex flex-col justify-center">
                        ...
                        {step === 2 && (
                            <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
                                ...
                                <label className="block text-4xl md:text-5xl font-black text-gray-900 tracking-tighter leading-none mb-8">
                                    Nice to meet you! <br />
                                    <span className="text-pink-500">Call you?</span>
                                </label>
                                <input
                                    type="text"
                        ...
                        {step === 3 && (
                            <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
                                <button
                                    ...
                                    className="mb-10 text-[10px] font-black text-pink-500 uppercase tracking-widest flex items-center gap-2"
                                >
                                    <span className="text-lg">←</span> {formData.name}
                                </button>
                                <label className="block text-4xl md:text-5xl font-black text-gray-900 tracking-tighter leading-none mb-8">
                                    How old <br />
                                    <span className="text-pink-500">are you?</span>
                                </label>
                                <input
                                    type="number"
                        ...
                        {step === 4 && (
                            <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
                                <button
                                    ...
                                    className="mb-10 text-[10px] font-black text-pink-500 uppercase tracking-widest flex items-center gap-2"
                                >
                                    <span className="text-lg">←</span> {formData.age}
                                </button>
                                <label className="block text-4xl md:text-5xl font-black text-gray-900 tracking-tighter leading-none mb-8">
                                    Your email <br />
                        ...
                        {/* Global Next Button (Only for steps > 1) */}
                        {step > 1 && (
